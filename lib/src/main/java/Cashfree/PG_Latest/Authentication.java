...
public class Authentication {
     ...
     */
    public Cashfree.PG_Latest.models.operations.OTPRequestResponse otpRequest(Cashfree.PG_Latest.models.operations.OTPRequestRequest request) throws Exception {
        String baseUrl = this.sdkConfiguration.serverUrl;
        String url = Cashfree.PG_Latest.utils.Utils.generateURL(Cashfree.PG_Latest.models.operations.OTPRequestRequest.class, baseUrl, "/orders/pay/authenticate/{payment_id}", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = Cashfree.PG_Latest.utils.Utils.serializeRequestBody(request, "otpRequest", "json");
        ...
        Cashfree.PG_Latest.models.operations.OTPRequestResponse res = new Cashfree.PG_Latest.models.operations.OTPRequestResponse(contentType, httpRes.statusCode()) {{
            otpResponseEntity = null;
            errorResponse = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (Cashfree.PG_Latest.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                Cashfree.PG_Latest.models.shared.OTPResponseEntity out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), Cashfree.PG_Latest.models.shared.OTPResponseEntity.class);
