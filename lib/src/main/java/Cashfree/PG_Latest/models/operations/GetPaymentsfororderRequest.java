...
public class GetPaymentsfororderRequest {
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=order_id")
    public String orderId;

    public GetPaymentsfororderRequest withOrderId(String orderId) {
    ...
    public GetPaymentsfororderRequest withXApiVersion(String xApiVersion) {
    ...
    public GetPaymentsfororderRequest withXClientId(String xClientId) {
    ...
    public GetPaymentsfororderRequest withXClientSecret(String xClientSecret) {
        this.xClientSecret = xClientSecret;
        return this;
    }
    
    public GetPaymentsfororderRequest(@JsonProperty("order_id") String orderId, @JsonProperty("x-client-id") String xClientId, @JsonProperty("x-client-secret") String xClientSecret) {
        this.orderId = orderId;
        this.xClientId = xClientId;
        this.xClientSecret = xClientSecret;
  }
