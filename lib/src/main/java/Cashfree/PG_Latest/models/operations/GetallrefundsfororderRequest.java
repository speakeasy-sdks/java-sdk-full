...
public class GetallrefundsfororderRequest {
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=order_id")
    public String orderId;

    public GetallrefundsfororderRequest withOrderId(String orderId) {
    ...
    public GetallrefundsfororderRequest withXApiVersion(String xApiVersion) {
    ...
    public GetallrefundsfororderRequest withXClientId(String xClientId) {
    ...
    public GetallrefundsfororderRequest withXClientSecret(String xClientSecret) {
        this.xClientSecret = xClientSecret;
        return this;
    }
    
    public GetallrefundsfororderRequest(@JsonProperty("order_id") String orderId, @JsonProperty("x-client-id") String xClientId, @JsonProperty("x-client-secret") String xClientSecret) {
        this.orderId = orderId;
        this.xClientId = xClientId;
        this.xClientSecret = xClientSecret;
  }
