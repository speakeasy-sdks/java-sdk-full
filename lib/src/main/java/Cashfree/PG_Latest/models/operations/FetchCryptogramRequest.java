...
public class FetchCryptogramRequest {
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=customer_id")
    public String customerId;

    public FetchCryptogramRequest withCustomerId(String customerId) {
    ...
    public FetchCryptogramRequest withInstrumentId(String instrumentId) {
    ...
    public FetchCryptogramRequest withXApiVersion(String xApiVersion) {
    ...
    public FetchCryptogramRequest withXClientId(String xClientId) {
    ...
    public FetchCryptogramRequest withXClientSecret(String xClientSecret) {
        this.xClientSecret = xClientSecret;
        return this;
    }
    
    public FetchCryptogramRequest(@JsonProperty("customer_id") String customerId, @JsonProperty("instrument_id") String instrumentId, @JsonProperty("x-client-id") String xClientId, @JsonProperty("x-client-secret") String xClientSecret) {
        this.customerId = customerId;
        this.instrumentId = instrumentId;
        this.xClientId = xClientId;
        this.xClientSecret = xClientSecret;
